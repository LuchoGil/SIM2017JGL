...
public class CongruencialLineal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btn_generar, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 180, -1, 50));

        jScrollPane1.setViewportView(lista);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 60, 200, 290));
        ...
        getContentPane().add(txt_g, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 120, 30, -1));
        ...
        getContentPane().add(txt_k, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 150, 30, -1));
    ...
    private void btn_generarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_generarActionPerformed
        // TODO add your handling code here:
        if(!this.validar());//valida la entrada de datos
        {
            System.out.println("hola");
            int semilla= Integer.parseInt(txt_x.getText());
        
            g= new Generador(Integer.parseInt(txt_a.getText()),Integer.parseInt(txt_c.getText()),Integer.parseInt(txt_m.getText()),Integer.parseInt(txt_x.getText()));
            lista.setListData(g.logicaLineal(20, semilla).toArray());
        //crea generador con todos los datos que se ingresaron y el metodo lineal devuelve un ArrayList que se asigna a la lista de la ventana
        }      
    ...
    private void btn_siguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_siguienteActionPerformed
        // TODO add your handling code here:
        if(!this.validar()){
        lista.setListData(g.logicaLineal(g.getLista().size()+1,g.getSemilla()).toArray());
        //logicaLineal retorna una lista con n+1 valores y usa como semilla el ultimo valor guardado en la semilla
        }
